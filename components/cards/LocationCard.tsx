    ...
    >
      ...
      <div className="absolute right-3 top-3 z-20">
        <button
          ...
          className="rounded-full border border-hairline bg-surface px-2.5 py-1 text-[10px] font-medium text-ink-soft shadow-floating transition-colors duration-200 hover:bg-surface-2 hover:text-ink"
        >
          Recenter
        </button>
      </div>
      ...
      <div className="absolute bottom-3 right-3 z-20 flex flex-col gap-1">
        <button
          ...
          aria-label="Zoom in"
          className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-hairline bg-surface text-ink shadow-floating transition-colors duration-200 hover:bg-surface-2"
        >
